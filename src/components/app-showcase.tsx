...
export const AppShowcase: React.FC = () => {
  ...
  return (
    <section className="relative overflow-hidden py-10 sm:py-14 bg-slate-50">
      {/* Main Outer Container */}
      <div className="container-wide relative z-10">
        <div className="relative overflow-hidden rounded-[2.5rem] bg-slate-900 border border-slate-200/80 shadow-2xl min-h-[580px] lg:min-h-[640px] flex flex-col justify-between">
          {/* ============================================================
          ...
          <div className="relative z-10 p-6 sm:p-10 lg:p-12">
            <div className="grid gap-8 lg:grid-cols-12 items-center">
              ...
              <div className="lg:col-span-6 space-y-5 text-left">
                ...
                >
                  <h2 className="font-display text-3xl sm:text-5xl lg:text-6xl font-extrabold text-slate-900 tracking-tight leading-[1.1]">
                    Real Estate,{' '}
                    <span className="bg-gradient-to-r from-red-600 via-rose-600 to-red-500 bg-clip-text text-transparent">
                      Reimagined
                    </span>
                  </h2>
                  <p className="mt-3 text-sm sm:text-base text-slate-700 leading-relaxed max-w-lg font-medium">
                ...
                <motion.div
                  ...
                  className="grid grid-cols-2 gap-2.5 max-w-md pt-1"
                >
                  {[
                    ...
                    <div
                      key={feat.label}
                      className="flex items-center gap-2.5 rounded-xl border border-slate-200/90 bg-white/95 px-3.5 py-2.5 shadow-sm backdrop-blur-md"
                    >
                ...
                <motion.div
                  ...
                  className="space-y-4 pt-3 border-t border-slate-300/60"
                >
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    <a
                      href="#"
                      className="flex items-center gap-3 rounded-2xl bg-slate-950 px-5 py-3 text-white shadow-xl hover:bg-slate-900 hover:scale-105 transition-all group"
                    >
                  ...
                  <div className="flex items-center gap-3.5 pt-1">
                    <div className="grid h-16 w-16 place-items-center rounded-2xl bg-white border border-slate-200 p-2 shadow-md shrink-0">
              ...
              <div className="lg:col-span-6 relative min-h-[460px] hidden lg:block">
                ...
                >
                  <img
                    ...
                    className="h-[520px] w-auto object-contain drop-shadow-2xl mix-blend-screen"
                  />
                </motion.div>
                ...
                <motion.div
                  ...
                  className="absolute left-6 top-8 z-20 w-40 rounded-2xl border border-white/80 bg-white/95 p-3 shadow-xl backdrop-blur-xl text-left"
                >
                ...
                <motion.div
                  ...
                  className="absolute left-2 top-48 z-20 w-40 rounded-2xl border border-white/80 bg-white/95 p-3 shadow-xl backdrop-blur-xl text-left"
                >
                ...
                <motion.div
                  ...
                  className="absolute left-8 bottom-12 z-20 w-40 rounded-2xl border border-white/80 bg-white/95 p-3 shadow-xl backdrop-blur-xl text-left"
                >
                ...
                <motion.div
                  ...
                  className="absolute right-4 top-10 z-20 w-40 rounded-2xl border border-white/80 bg-white/95 p-3 shadow-xl backdrop-blur-xl text-left"
                >
                ...
                <motion.div
                  ...
                  className="absolute right-0 top-44 z-20 w-40 rounded-2xl border border-white/80 bg-white/95 p-3 shadow-xl backdrop-blur-xl text-left"
                >
                ...
                <motion.div
                  ...
                  className="absolute right-6 bottom-14 z-20 w-44 rounded-2xl border border-white/80 bg-white/95 p-3 shadow-xl backdrop-blur-xl text-left"
                >
          ...
          <div className="relative z-10 p-6 pt-0">
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="rounded-2xl border border-slate-200/90 bg-white/95 p-3.5 shadow-lg backdrop-blur-md"
            >
