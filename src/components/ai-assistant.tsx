    ...
    <>
      <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-3">
        <a
          ...
          className="flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-cardHover transition hover:bg-[#20bd5a]"
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-full bg-navy-700 px-4 py-3 text-sm font-bold text-white shadow-cardHover hover:bg-navy-800 transition"
        >
          <Sparkles className="h-5 w-5 text-gold-400" /> {t('ai.assistant', 'AI Assistant')}
        </button>
      </div>
